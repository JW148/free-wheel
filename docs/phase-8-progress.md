# Phase 8 — region downloads

> Built as "Phase 6" on a branch cut before Phase 6 (navigation) and Phase 7 (the ride's
> feedback) landed on `main`, and renumbered when it merged. `docs/superpowers/plans/` and
> `specs/` keep their original filenames and still say "Phase 6" — they are dated records of
> what was planned on 2026-09-11, and rewriting them would make them records of something
> else. Where they say Phase 6, read Phase 8; where they say Phase 7, read Phase 9.
...
- **The on-device acceptance test — cold launch, tap a region, airplane mode, plan and follow —
  ...
  iPhone, neither in reach of this task. This remains the actual bar for calling Phase 8 done,
